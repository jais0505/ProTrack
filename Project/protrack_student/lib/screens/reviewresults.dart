...
class ReviewResults extends StatefulWidget {
  final int gid;
  const ReviewResults({super.key, required this.gid});

  @override
  State<ReviewResults> createState() => _ReviewResultsState();
}

class _ReviewResultsState extends State<ReviewResults> {
  ...
  Future<void> fetchReview() async {
    final response =
        await supabase.from('tbl_review').select().eq('group_id', widget.gid);
    print(response);
    setState(() {
